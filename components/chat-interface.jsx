      ...
      <div className="flex justify-between items-center px-4 py-2 border-b">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="hidden sm:inline ml-2">历史({conversationsCount})</span>
          </Button>
          <Button
            variant="outline"
            size="sm"
            onClick={() => {
              const newContent = prompt("请输入新图表的描述:");
              if (newContent?.trim() && onCreateConversation) {
                onCreateConversation(newContent.trim());
              }
            }}
            className="h-8"
            title="新建对话"
              ...
              {!isCodeExpanded ? (
                ...
                <div className="h-full flex flex-col">
                  ...
                  <div className="flex-1 overflow-hidden">
                    <Textarea
                      value={isStreaming ? streamingContent || "等待生成..." : mermaidCode}
                ...
                <div className="h-full flex flex-col">
                  <div className="flex items-center justify-between p-2 bg-gray-50 border-b">
                    <div className="flex items-center gap-2">
                      ...
                      {isStreaming && (
                        <div className="animate-pulse h-2 w-2 rounded-full bg-gray-500"></div>
                      )}
                    </div>
